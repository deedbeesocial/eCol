...
export default function Contact() {
  ...
  return (
    <>
                ...
                <form className="mt-8" onSubmit={sendMessage}>
                  <div className="lg:grid flex flex-col justify-center lg:grid-cols-2 gap-6">
                    ...
                    <label className="block">
                      ...
                      <input
                        type="email"
                        className=" block w-full rounded-sm    lg:h-[47px]  focus:border-gr focus:ring focus:ring- focus:ring-opacity-50"
                        placeholder=""
                        value={email}
      ...
      <section>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.919291103342!2d77.61561581536508!3d12.977013818269358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae16851f62c561%3A0xbd1287a493e651fc!2sAlt%20Tech%20Foundation!5e0!3m2!1sen!2sin!4v1668075093036!5m2!1sen!2sin" width="100%" height="650"  allowFullScreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </section>
    </>
  );
}
